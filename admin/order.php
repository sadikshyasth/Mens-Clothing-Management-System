...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        foreach ($result as $row) {
        	...
        	if($row['payment_method'] == 'Debit Card'):
				$payment_details = '
Card Holder Name: '.$row['card_holder_name'].'<br>
Card Month: '.$row['card_expity'].'<br>
            	...
            	foreach ($result as $row) {
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
                        ...
                        <td>
                        	...
                        	<?php elseif($row['payment_method'] == 'Debit Card'): ?>
                        		<b>Payment Method:</b> <?php echo '<span style="color:red;"><b>'.$row['payment_method'].'</b></span>'; ?><br>
                        		<b>Payment Id:</b> <?php echo $row['payment_id']; ?><br>
								<b>Date:</b> <?php echo $row['payment_date']; ?><br>
								<b>Card Holder Name:</b> <?php echo $row['card_holder_name']; ?><br>
								<b>Card Expiry:</b> <?php echo $row['card_expiry']; ?>
								<br>

                                <?php elseif($row['payment_method'] == 'Khalti'): ?>
                        		<b>Payment Method:</b> <?php echo '<span style="color:red;"><b>'.$row['payment_method'].'</b></span>'; ?><br>
                        		<b>Payment Id:</b> <?php echo $row['payment_id']; ?><br>
								<b>Date:</b> <?php echo $row['payment_date']; ?><br>
