...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_id'])) {
    	...
    	$statement = $pdo->prepare("SELECT * FROM tbl_delivery_cost WHERE shipping_cost_id=?");
		...
		$statement = $pdo->prepare("SELECT * FROM tbl_delivery_cost WHERE country_id=? and country_id!=?");
    ...
    if($valid == 1) {    	
		...
		$statement = $pdo->prepare("UPDATE tbl_delivery_cost SET country_id=?,amount=? WHERE shipping_cost_id=?");
