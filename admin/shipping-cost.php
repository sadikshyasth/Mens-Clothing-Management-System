...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        $statement = $pdo->prepare("INSERT INTO tbl_delivery_cost (country_id,amount) VALUES (?,?)");
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $statement = $pdo->prepare("UPDATE tbl_delivery_cost_all SET amount=? WHERE sca_id=1");
                            ...
                            <div class="col-sm-4">
                                <select name="country_id" class="form-control select2">
                                    ...
                                    foreach ($result as $row) {
                                        ...
                                        $statement = $pdo->prepare("SELECT * FROM tbl_delivery_cost WHERE country_id=?");
