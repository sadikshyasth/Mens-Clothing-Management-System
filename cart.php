			...
			<div class="col-md-12">
                    ...
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="number" class="input-text qty text" step="1" min="1" max="30" name="quantity[]" value="<?php echo $arr_cart_p_qty[$i]; ?>" title="Qty" size="4" pattern="[0-9]*" inputmode="numeric">
                            </td>
                            <td class="text-right">
                                <?php
                                ...
                                ?>
                                <?php echo  "Rs "; ?><?php echo $row_total_price; ?>
                            </td>
                ...
                <div class="cart-buttons">
                    <ul>
                        ...
                        <li><a href="checkout.php" class="btn btn-primary"><?php echo "Proceed to Checkout"; ?></a></li>
                    </ul>
                </div>
                </form>
                <?php endif; ?>
