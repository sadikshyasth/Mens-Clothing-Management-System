...
if (isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $statement->execute(array(sha1($password),$_SESSION['customer']['cust_id']));
        
        $_SESSION['customer']['cust_password'] = sha1($password);        
        ...
        <div class="row">            
            ...
            <div class="col-md-12">
                <div class="user-content">
                    ...
                    <form action="" id="psw_update" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" id="myInput" class="form-control" name="cust_password">
                                </div>
                                <div class="form-group">
...
<script>
     document.getElementById('psw_update').addEventListener('submit', function (event) {
