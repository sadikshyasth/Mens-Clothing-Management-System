			...
			if(isset($_POST['form_subscribe']))
			{
			    ...
			    else
			    {
				    ...
				    else
				    {
						...
						$result= $Footer_obj->getSubscriberDetails($_POST['email_subscribe']);
						// $total= $login_object->getRows($subs_email);
...
This link will be active only for 24 hours.
					';
							...
							$success_message1 = "Thanks for your interest to subscribe our newsletter!";
				    	}
				    }
			    }
			}
