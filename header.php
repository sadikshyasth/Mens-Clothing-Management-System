...
<head>
	...
	if($cur_page == 'index.php' || $cur_page == 'login.php' || $cur_page == 'registration.php' || $cur_page == 'cart.php' || $cur_page == 'checkout.php' || $cur_page == 'forget-password.php' || $cur_page == 'reset-password.php' || $cur_page == 'product-category.php' || $cur_page == 'product.php') {
		?>
		<title><?php echo "Men's Collection"; ?></title>
			...
			<div class="col-md-5 right">
				<ul>
					...
					if(isset($_SESSION['customer'])) {
						...
						<li><a href="dashboard.php"><i class="fa fa-home"></i> <?php echo "Dashboard"; ?></a></li>
						<?php
					} else {
						?>
					...
					<li><a href="cart.php"><i class="fa fa-shopping-cart"></i> <?php echo "Cart"; ?> (<?php echo "Rs "; ?><?php
			...
			<div class="col-md-3 search-area">
				<form class="navbar-form navbar-left" role="search" action="search-result.php" method="get">
					...
					<div class="form-group">
						<input type="text" class="form-control search-top" placeholder="<?php echo "Search Product"; ?>" name="search_text">
					</div>
					...
					<div class="menu">
						<ul>
							...
							<?php
								...
								foreach ($result as $row) {
								?>
								<li><a href="product-category.php?id=<?php echo $row['tcat_id']; ?>&type=top-category"><?php echo "Categories"; ?></a>
									<ul>
										<?php
